...
import (
	...
	"github.com/MeshBoxFoundation/meshiot/crypto/signify"
	"github.com/MeshBoxFoundation/meshiot/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/MeshBoxFoundation/meshiot/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/MeshBoxFoundation/meshiot/mobile")
